...
| 5 (Harbor, disabled)   | PR [#4486](https://github.com/mmalyska/home-ops/pull/4486). Final whole-branch review found a latent auth bug, fixed in the same PR — see Deviation 2 below.                                                                               |
| 6 (Gitea, disabled)    | PR [#4487](https://github.com/mmalyska/home-ops/pull/4487), stacked on #4486.                                                                                                                                                              |
